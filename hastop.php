      ...
      <!-- <div class="row">
        <div class="col-lg-8 col-lg-offset-2">
          <div class="panel panel-info">
            <div class="panel-heading" style="background-color: #13464b; color: white ;">
              Halaman Untuk Mencetak Tabel
            </div>
            <div class="panel-body">
            <a class="btn btn-primary" href="export2.php" role="button" >Edit Tabel</a>
            <a class="btn btn-success" href="export1.php" role="button" >Export Tabel</a>
              ...
              <table class="table table-striped table-bordered " >
                ...
                <tbody>
                  ...
                  foreach($data as $nama=>$krit){
                    ...
                    $tampil = round($V[$i-1],4,PHP_ROUND_HALF_UP);
      	...
      	<div class="col-lg-10 " style="margin-left: 100px; margin-right: 100px;">
            ...
            <div class="panel-body">
              <table class="table table-striped table-bordered table-hover">
                ...
                <tbody>
                  <?php
               //Atauerror_reporting(E_ALL && ~E_NOTICE);
                  $i=0;
                  foreach($data as $nama=>$krit){
                    echo "<tr>
                    <td style='text-align: center;'>".(++$i)."</td>
                      <td style='text-align: center;'>$nama</td>";
                    foreach($kriteria as $k){
                      echo "<td align='center' class='coba'>$krit[$k]</td>";
                      error_reporting(0);
            ...
            <div class="panel-body" >
              <table class="table table-striped table-bordered table-hover">
                <thead>
                  <tr>
                    <th rowspan='3'>No</th>
                    <th rowspan='3'>Kode Alternatif</th>
                    <th rowspan='3'>Nama</th>
                    <th colspan='<?php echo $jml_kriteria;?>'>Kriteria</th>
                  </tr>
                  <tr>
      ...
      <div class="footer-below">
        <div class="container">
          <div class="row">
            ...
            <h5 style="margin: 10px; color:  #13464b;" class="text-white">2022 © Cv Fajar Jaya</h5>
