...
<link href="tampilan/font-awesome/css/font-awesome.min.css" rel="stylesheet" type="text/css">
    ...
    <div class="header-3-3 container-xxl mx-auto p-0 position-relative" style="font-family: 'Poppins', sans-serif">
      <nav class="navbar navbar-expand-lg navbar-light">
        <a href="index.php">
          <img style="margin-right: 0.75rem; height: 80px; width: 80px; " 
            src="tampilan/img/logo.svg" alt="" />
        </a>
        ...
        <div class="modal-item modal fade" id="targetModal-item" tabindex="-1" role="dialog"
          ...
          <div class="modal-dialog" role="document">
            ...
            src="tampilan/img/logo.svg" alt="" />
              ...
              <div class="modal-body" style="padding: 2rem; padding-top: 0; padding-bottom: 0">
                <ul class="navbar-nav responsive me-auto mt-2 mt-lg-0">
                  <li class="nav-item active position-relative">
                    <a class="nav-link main" style="color: #243142;" href="index.php">Beranda</a>
                  </li>
                  ...
                  <li class="nav-item position-relative">
                    <a class="nav-link" href="h.php">Pengumuman</a>
                  </li>
              ...
              <a class="btn text-white" style="background-color: #0cc4b6;" href="login.php" role="button">
							Admin
</a>
              </div>
            </div>
        ...
        <div class="collapse navbar-collapse" id="navbarTogglerDemo">
          <ul class="navbar-nav mx-auto mt-2 mt-lg-0">
            ...
            <li class="nav-item position-relative">
              <a class="nav-link" href="vHastop.php">Pengumuman</a>
            </li>
          </ul>
		  <a class="btn text-white" style="background-color: #0cc4b6;" href="login.php" role="button">
							Admin
