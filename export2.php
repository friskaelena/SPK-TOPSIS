...
<div class="container">
  <br>
			<h1 align="Center" style="margin-bottom: 50px;">SPK - Toko Yogi Banyumas</h1>
     
      <br>
      <br>
      <div class="container" style="margin: -50px;" > <!--container-->
      <div class="row">
      ...
      <div class="row">
        <div class="col-lg-10 col-lg-offset-2" style="margin-bottom: 50px;">
          <div class="panel panel-info">
            <div class="panel-heading">
             <h4>  Kembali Ke Halaman Hasil Topsis ?</h4>
            </div>
            <a class="btn btn-primary" href="hastop.php" role="button"> <h4>Kembali</h4> </a>    
          </div>
          </div>
        </div>
      </div>
